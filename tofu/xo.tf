...
provider "xenorchestra" {
  # Must be ws or wss
  url      = "ws://xo.gssn.xyz" # Or set XOA_URL environment variable
...
#  password = "<password>"              # Or set XOA_PASSWORD environment variable
  ...
  # used sparingly!
#  insecure = true|false            # Or set XOA_INSECURE environment variable to any value
}

#provider "xenorchestratokenauth" {
